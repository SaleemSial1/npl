...
All flags forward through `".agents/skills/seo/scripts/claude-seo" run unlighthouse_run.py`, which handles
...
- For LCP subpart decomposition on slow pages, use the
  `".agents/skills/seo/scripts/claude-seo" run lcp_subparts.py` workflow (Phase C).
