...
- Raw HTML + rendered HTML (via `".agents/skills/seo/scripts/claude-seo" run render_page.py`)
...
- Core Web Vitals field data from CrUX (via `".agents/skills/seo/scripts/claude-seo" run pagespeed_check.py`)
...
- A PDF via `".agents/skills/seo/scripts/claude-seo" run google_report.py` when the user asks for one.
