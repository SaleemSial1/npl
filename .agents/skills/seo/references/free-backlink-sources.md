...
This is enforced, not advisory: `".agents/skills/seo/scripts/claude-seo" run validate_backlink_report.py` fails
...
- **Command:** `".agents/skills/seo/scripts/claude-seo" run moz_api.py`
...
- **Command:** `".agents/skills/seo/scripts/claude-seo" run bing_webmaster.py`
...
- **Command:** `".agents/skills/seo/scripts/claude-seo" run commoncrawl_graph.py`
...
- **Command:** `".agents/skills/seo/scripts/claude-seo" run verify_backlinks.py`
