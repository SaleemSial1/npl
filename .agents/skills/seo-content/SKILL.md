...
```bash
".agents/skills/seo/scripts/claude-seo" run content_humanize.py draft.md -o cleaned.md
cat draft.md | ".agents/skills/seo/scripts/claude-seo" run content_humanize.py --json
```
