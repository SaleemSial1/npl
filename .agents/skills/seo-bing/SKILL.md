...
|---|---|
| `/seo bing links <url>` | `".agents/skills/seo/scripts/claude-seo" run bing_webmaster.py links <url>` |
| `/seo bing compare <urlA> <urlB>` | `".agents/skills/seo/scripts/claude-seo" run bing_webmaster.py compare <urlA> <urlB>`; both properties must be registered to the API account |
| `/seo bing submit <url>` (single URL) | `".agents/skills/seo/scripts/claude-seo" run indexnow_submit.py --host ... --urls <url>` |
| `/seo bing submit-batch <file>` | `".agents/skills/seo/scripts/claude-seo" run indexnow_submit.py --host ... --urls-file <file>` |
| `/seo bing verify-indexnow` | `".agents/skills/seo/scripts/claude-seo" run indexnow_submit.py --host ... --verify-only` |
