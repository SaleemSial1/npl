...
- `".agents/skills/seo/scripts/claude-seo" run drift_baseline.py <url>` -- capture a new baseline
- `".agents/skills/seo/scripts/claude-seo" run drift_compare.py <url>` -- compare current state to baseline
- `".agents/skills/seo/scripts/claude-seo" run drift_history.py <url>` -- show change history
- `".agents/skills/seo/scripts/claude-seo" run drift_report.py <file> --output report.html` -- generate HTML report
