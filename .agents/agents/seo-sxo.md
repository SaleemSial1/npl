...
- Fetch the target URL using `".agents/skills/seo/scripts/claude-seo" run render_page.py "<url>" --mode auto --json` (SPA-aware SSRF-protected renderer)
- Parse with `".agents/skills/seo/scripts/claude-seo" run parse_html.py --url "<url>"` to extract SEO elements
...
- [ ] URL was fetched via `".agents/skills/seo/scripts/claude-seo" run render_page.py --mode auto` (not raw curl)
