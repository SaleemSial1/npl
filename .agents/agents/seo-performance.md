...
2. Use `".agents/skills/seo/scripts/claude-seo" run render_page.py <URL> --mode auto --json` before HTML/source inspection so SPA content is visible when needed
...
".agents/skills/seo/scripts/claude-seo" run pagespeed_check.py URL --json

# SPA-aware HTML/render inspection
".agents/skills/seo/scripts/claude-seo" run render_page.py URL --mode auto --json
...
```bash
".agents/skills/seo/scripts/claude-seo" run pagespeed_check.py URL --json
".agents/skills/seo/scripts/claude-seo" run crux_history.py URL --json
```
