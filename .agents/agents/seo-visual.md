...
```bash
".agents/skills/seo/scripts/claude-seo" run capture_screenshot.py URL --all --output screenshots/
".agents/skills/seo/scripts/claude-seo" run render_page.py URL --mode auto --a11y-tree --json
```
