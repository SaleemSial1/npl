...
```
".agents/skills/seo/scripts/claude-seo" run metadata_template.py --title "<title>" --description "<desc>" --json
```
...
```
".agents/skills/seo/scripts/claude-seo" run metadata_template.py --pairs-file metadata.json --json
```
